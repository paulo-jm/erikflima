...
import com.guusto.buygift.merchant.mapping.entity.MerchantPartnerEntity_;
...
public class SearchMerchantPartner implements Specification {
	...
	public <T> Predicate toPredicate(CriteriaBuilder criteriaBuilder, CriteriaQuery<T> criteriaQuery, Root<?> root,
		...
		Predicate qPredicate = PredicateUtils.or(criteriaBuilder, PredicateUtils.like(q,
				expressionHandler.getExpression(MerchantPartnerEntity_.merchantPartnerName), criteriaBuilder));
